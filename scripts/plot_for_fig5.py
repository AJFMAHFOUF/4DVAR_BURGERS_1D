...
import numpy as np
x,ub00_001,ut00_001,ua00_001=np.loadtxt('../data/output_00h_100.dat',unpack=True)
x,ub24_001,ut24_001,ua24_001=np.loadtxt('../data/output_24h_100.dat',unpack=True)
x,ub48_001,ut48_001,ua48_001=np.loadtxt('../data/output_48h_100.dat',unpack=True)
x,ub00_002,ut00_002,ua00_002=np.loadtxt('../data/output_00h_007.dat',unpack=True)
x,ub24_002,ut24_002,ua24_002=np.loadtxt('../data/output_24h_007.dat',unpack=True)
x,ub48_002,ut48_002,ua48_002=np.loadtxt('../data/output_48h_007.dat',unpack=True)
x,ub00_003,ut00_003,ua00_003=np.loadtxt('../data/output_00h_100.dat',unpack=True)
x,ub24_003,ut24_003,ua24_003=np.loadtxt('../data/output_24h_100.dat',unpack=True)
x,ub48_003,ut48_003,ua48_003=np.loadtxt('../data/output_48h_100.dat',unpack=True)
x,ub00_004,ut00_004,ua00_004=np.loadtxt('../data/output_00h_100.dat',unpack=True)
x,ub24_004,ut24_004,ua24_004=np.loadtxt('../data/output_24h_100.dat',unpack=True)
x,ub48_004,ut48_004,ua48_004=np.loadtxt('../data/output_48h_100.dat',unpack=True)
fig=plt.figure()
