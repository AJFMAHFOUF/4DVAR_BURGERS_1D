module mod_vars
 ...
 integer, parameter :: mm = 5*5*5             ! maximum wave number
 integer, parameter :: nlon = 2*mm            ! number of longitudes
 integer, parameter :: nobs = nlon/5          ! number of obserations per time slot
